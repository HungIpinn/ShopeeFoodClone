      ...
      >
        <View style={styles.container}>
          <View style={styles.containerText}>
            ...
            <Text style={styles.Line3Text}>
              Your favourite food delivery fast at your door
            </Text>
          </View>
          <View style={styles.containerBtn}>
            <SocailMeidaButton TextInLine="Đăng nhập với" />
            ...
            <View style={styles.containerTextFooter}>
              ...
              <MyPressable onPress={() => navigation.navigate('SignUp')}>
                <Text>Đăng ký</Text>
              </MyPressable>
            </View>
          </View>
